...
- **Features**
  ...
  - Made app user and roles configurable via values in the bootstrap-mongodb feature.

- **Fixes**
  - Used `/bin/bash` instead of `/bin/sh` for the mongosh container in the bootstrap-mongodb feature.
