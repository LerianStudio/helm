...
- **Features:**
  - Introduced schema migration Jobs for seamless transitions.
  - Enabled providersIngress for outbound-provider adapters.
  - Implemented shared multi-path ingresses for enhanced routing.
  - Added bootstrap Jobs for PostgreSQL and MongoDB support.
