...
* **plugin-auth:** create plugin access manager auth templates ([deea8c8](https://github.com/LerianStudio/helm/commit/deea8c8a10622d1bf574ee10250bdf693506e253))
* **chart:** create plugin access manager chart file ([a83710f](https://github.com/LerianStudio/helm/commit/a83710f7b2a0a439113b024daf707f1fc8474294))
* **dependencies:** create plugin access manager dependencies charts ([e98e1a0](https://github.com/LerianStudio/helm/commit/e98e1a0032b78069dbf039cf740818123ee16ebc))
* **dependencies:** create plugin access manager dependencies init files ([e4fc082](https://github.com/LerianStudio/helm/commit/e4fc08240e9261aab4a273fb9d24a9e80b164a9e))
* **chart:** create plugin access manager helm chart ([272aa8f](https://github.com/LerianStudio/helm/commit/272aa8f90b17d34d5471914d2bdd470a6b1af5b0))
* **plugin-identity:** create plugin access manager identity templates ([e2c0a7e](https://github.com/LerianStudio/helm/commit/e2c0a7e6cc8fbd980758414b132f5626d4351c90))
* **plugin-access-manager:** create plugin access manager templates ([39380a6](https://github.com/LerianStudio/helm/commit/39380a6fd2a126a1c9c4a39f0bbd9a98e1c468a2))
* **values:** create plugin access manager values ([38e3423](https://github.com/LerianStudio/helm/commit/38e34232e8e53d2c849cce4466de11a077ed672e))
...
* **pipe:** test new pipe ([767e2ca](https://github.com/LerianStudio/helm/commit/767e2ca83b91e8662a498b06415bf4ddc992caac))
* **pipe:** trigger new pipe ([c6efa46](https://github.com/LerianStudio/helm/commit/c6efa46f17823c06c6ca9dfcf9af78fb116ac943))
* **pipe:** trigger new pipe ([9598c5d](https://github.com/LerianStudio/helm/commit/9598c5dba9554628320b59836e659ad5f8180433))
* **pipe:** trigger new pipe ([2745e2c](https://github.com/LerianStudio/helm/commit/2745e2cd7d6edd0559db8c0a4909641ccf0f398a))
* **pipe:** trigger new pipe ([045c72c](https://github.com/LerianStudio/helm/commit/045c72c07961773dbf499a2a76abdac0ed1fab8f))
* **pipe:** trigger new pipe ([16bc645](https://github.com/LerianStudio/helm/commit/16bc645c7b61482b8ffeb55583be0fee2f01fd17))
* **pipe:** trigger new pipe ([3c10457](https://github.com/LerianStudio/helm/commit/3c104577f449246128a3485d80999234c34dd35f))
* **pipe:** trigger new pipe ([4bc1aa3](https://github.com/LerianStudio/helm/commit/4bc1aa39935e59e8e193d8554990b8c038d5c060))
* **pipe:** trigger new pipe ([9e1e89d](https://github.com/LerianStudio/helm/commit/9e1e89dc63b9d63b3aeba0fd14f2b59d00fac261))
...
* **dependencies:** update configmap config file ([63523c2](https://github.com/LerianStudio/helm/commit/63523c2418cdad670e76fe8e32ae1cf21ee98fec))
* **chart:** update configmap identity ([e2ca6c2](https://github.com/LerianStudio/helm/commit/e2ca6c2ed8b5bfa76e4cec51c3bd83ebb392e1df))
...
* **chart:** update deployment tempalte for auth chart ([1010e14](https://github.com/LerianStudio/helm/commit/1010e1457fcb65bfd465bdbe465ea0c72dcc7d42))
...
* **dependencies:** update init config file ([6e7b306](https://github.com/LerianStudio/helm/commit/6e7b306a49631c5af87eef62ce3d4f540c1b9342))
* **dependencies:** update init sql file ([566fff9](https://github.com/LerianStudio/helm/commit/566fff99bae17238f792495e615c72c38965af74))
...
* **values:** update plugin access manager values file ([1e8d545](https://github.com/LerianStudio/helm/commit/1e8d545c2e4e21661018b06de89b414b9f775f7b))
...
* **pipe:** modify releaserc to create release for all charts ([bfaf5ba](https://github.com/LerianStudio/helm/commit/bfaf5ba911d8e928921979695ad3a984e7099911))
* **pipe:** modify workflow to create release for all charts ([63f8fd1](https://github.com/LerianStudio/helm/commit/63f8fd116289d042d7b142e55ba75d500133eb30))
...
## [1.53.0](https://github.com/LerianStudio/helm/compare/v1.52.0...v1.53.0) (2025-04-08)
...
## [1.51.1](https://github.com/LerianStudio/midaz-helm-standalone/compare/v1.51.0...v1.51.1) (2025-03-24)
...
## [1.12.8](https://github.com/LerianStudio/midaz-helm/compare/v1.12.7...v1.12.8) (2024-06-05)

## [1.12.7](https://github.com/LerianStudio/midaz-helm/compare/v1.12.6...v1.12.7) (2024-06-05)

## [1.12.6](https://github.com/LerianStudio/midaz-helm/compare/v1.12.5...v1.12.6) (2024-06-03)

## [1.12.5](https://github.com/LerianStudio/midaz-helm/compare/v1.12.4...v1.12.5) (2024-06-03)
