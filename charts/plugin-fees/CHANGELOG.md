...
- **Features:**
  ...
  - Introduced a single-source MongoDB password refactor for improved security and management.

- **Fixes:**
  - Addressed CodeRabbit review comments on the revamp PR for better code quality.
  - Fixed schemas to allow additional properties in values.schema.json files.

- **Improvements:**
  - Standardized charts to comply with the Lerian chart contract for consistency.
