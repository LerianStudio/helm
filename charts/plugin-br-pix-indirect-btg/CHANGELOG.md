...
- **Improvements:**
  - Refactored mTLS implementation to use `fsGroup` with 0440 direct mount, removing the need for an init container.
  - Added mTLS block to values-template for better configuration management.
  - Dropped hand-written mTLS documentation in favor of auto-generated documentation on release.
