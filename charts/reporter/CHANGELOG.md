...
## Changelog for Reporter

### Features
- Parametrized probe path and timing for readiness checks using `/readyz`.

### Fixes
- Dropped KEDA authRef on CPU/memory configurations.

### Improvements
- Single-source MongoDB and RabbitMQ secrets for enhanced security and management.
