...
- **Features:**
  - Updated `pix` to version 1.2.1-beta.11 and `job` to version 1.2.1-beta.11 with new environment variables.
  - Updated `pix` to version 1.2.1-beta.10 and `job` to version 1.2.1-beta.10 with new environment variables.
