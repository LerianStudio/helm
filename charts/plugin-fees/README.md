...
```console
$ helm upgrade plugin-fees oci://registry-1.docker.io/lerianstudio/plugin-fees-helm --version <new-version> -n midaz-plugins
```
...
| `fees.image.tag` | Image tag used for deployment | `3.2.0` |
