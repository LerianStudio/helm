...
- Features:
  - Released version 2.1.0 with enhanced data fetching capabilities.

- Fixes:
  - Addressed minor bugs to improve stability and performance.

- Improvements:
  - Optimized internal processes for faster data retrieval.
  - Improved error handling to provide more informative logs.
