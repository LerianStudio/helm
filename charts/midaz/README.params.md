...
| `ledger.image.tag` | string | `"3.8.0"` | Image tag used for deployment |
...
| `ledger.extraEnvVars` | list | `[]` | Extra environment variables |
...
| `tracer.image.tag` | string | `"4.0.0-beta.24"` | Image tag used for deployment |
