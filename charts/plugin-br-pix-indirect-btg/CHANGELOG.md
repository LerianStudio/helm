...
- **Fixes:**
  - Updated `plugin-br-pix-indirect-btg` to version 1.9.1 to address existing issues.

- **Improvements:**
  - Added documentation for creating a secret using `kubectl create secret tls` and included notes on both registries.
