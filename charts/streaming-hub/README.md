...
| `streamingHub.configmap` | `{}` | Non-sensitive env override hatch (defaults live in `templates/configmap.yaml`). `configmap.<KEY>` overrides an enumerated key or injects an un-enumerated one. See `README.params.md`. |
