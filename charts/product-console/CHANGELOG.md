...
- **Fixes:**
  - Addressed issues in chart schemas to allow additional properties in `values.schema.json` files.
  - Resolved CodeRabbit review comments on the chart revamp PR.
