...
- **Features**
  - Added a variant for creating TLS secrets using `kubectl` and included notes on both registries.

- **Fixes**
  - Updated the namespace placeholder and pod selectors in the UPGRADE-3.7 documentation.

- **Improvements**
  - Released version 1.9.1 of the plugin-br-pix-indirect-btg.
