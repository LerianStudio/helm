...
- **Fixes:**
  ...
  - Prevented the acceptance of an empty MongoDB existingSecret.

- **Improvements:**
  - Updated documentation to include uninstall instructions within its namespace before data deletion.
