...
- **Fixes:**
  - Run the credential sidecar under runtime seccomp to enhance security. This fix was implemented in two separate commits (#2277 and 9c0efc01).

- **Documentation:**
  - Addressed CodeRabbit findings on UPGRADE-8.0.md to improve clarity and accuracy.
  - Added an upgrade guide for plugin-fees v8.0.1, providing detailed instructions for users.
  - Clarified that the CLIENT_ID move is backward-compatible, ensuring no breaking changes for users.
  - Created UPGRADE-8.0.md with strict guidelines: focus solely on plugin-fees, use bullet points, group by Features, Fixes, and Improvements, and limit to 5 bullet points.
...
- Fixes:
  - Restore CLIENT_ID backward compatibility for plugin-fees.
...
- Fixes:
  - Restore CLIENT_ID backward compatibility in plugin-fees.
...
- **Features**
  - Updated to plugin-fees version 3.4.0.
...
- **Features**
  - Updated plugin-fees to version 3.4.0.
...
- **Features**
  - Update plugin-fees to version 3.4.0.
...
- **Features:**
  ...
  - Introduced single-source MongoDB password refactoring.
...
- **Improvements:**
  - Refactored plugin-fees to single-source MongoDB password for better maintainability.
...
- **Features:**
  - Added ALLOW_INSECURE_TLS configuration to multiple charts and updated image tags.
  - Implemented single-source MongoDB password refactoring for better security management.
...
- **Improvements:**
  - Standardized charts to align with the Lerian chart contract.
  - Removed redundant dependency helpers and updated continuous integration processes.
...
- **Features:**
  - Added ALLOW_INSECURE_TLS configuration to enhance security options.
  - Implemented a single-source MongoDB password for improved security management.

- **Fixes:**
  - Addressed issues with schemas by allowing additional properties in values.schema.json files.
  - Resolved CodeRabbit review comments on chart revamp PR #1470.
  - Fixed collapse-aware infra host fallbacks for better stability.
...
- **Features:**
  - Added ALLOW_INSECURE_TLS configuration to support more flexible TLS settings.
  - Introduced a single-source MongoDB password refactor for improved security and maintainability.

- **Fixes:**
  - Addressed issues with schemas to allow additional properties in `values.schema.json` files.
  - Implemented collapse-aware infra host fallbacks to enhance reliability.
  - Resolved issues related to collapse-safe Bitnami name derivation.

- **Improvements:**
  - Standardized charts to comply with the Lerian chart contract for better consistency.
  - Removed redundant dependency helpers and updated CI processes for efficiency.
...
- **Features:**
  - Added ALLOW_INSECURE_TLS configuration to charts.
  - Implemented single-source MongoDB password refactoring.
...
- **Features:**
  - Added ALLOW_INSECURE_TLS configuration to plugin-fees.
  - Introduced a single-source MongoDB password refactor for plugin-fees.

- **Fixes:**
  - Addressed CodeRabbit review comments on the revamp PR for plugin-fees.
  - Resolved issues related to collapse-aware infra host fallbacks in plugin-fees charts.

- **Improvements:**
  - Standardized plugin-fees charts to align with the Lerian chart contract.
  - Removed redundant dependency helpers and updated CI processes for plugin-fees.
...
- **Fixes:**
  ...
  - Fixed collapse-safe Bitnami name derivation.
...
- **Features:**
  - Added ALLOW_INSECURE_TLS configuration to multiple charts and updated image tags.
  - Implemented a per-chart values.schema.json generator.
...
- **Improvements:**
  - Refactored to single-source MongoDB password.
  - Standardized charts to lerian chart contract.
...
- **Improvements:**
  ...
  - Parametrize probe path and timing using /readyz.
...
- **Features:**
  - Added deployment mode and readiness timeout settings.
  - Added SA template Fees.
  - Disabled SA create functionality.
...
- **Features**
  - Added support for `APPLICATION_NAME`, `MULTI_TENANT_TIMEOUT`, and `MULTI_TENANT_CACHE_TTL_SEC` environment variables.
...
[Compare changes](https://github.com/LerianStudio/helm/compare/plugin-fees-v5.1.0...plugin-fees-v5.2.0)
...
- Fixes:
  - Updated plugin-fees to version 3.0.8 to resolve existing issues.
...
## [4.1.1](https://github.com/LerianStudio/helm/releases/tag/plugin-fees-v4.1.1)

- Improvements:
  - Enhanced the fee calculation algorithm for better accuracy.
  - Optimized the performance of the fee processing module.
  - Improved logging for fee-related transactions to aid in debugging.

Contributors:

[Compare changes](https://github.com/LerianStudio/helm/compare/plugin-fees-v4.1.0...plugin-fees-v4.1.1)
