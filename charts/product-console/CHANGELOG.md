...
- **Fixes:**
  ...
  - Correct mongosh flags by removing the non-existent --tlsInsecure flag.
  - Mark bootstrap-mongodb Job as a native Helm hook and make it self-healing on ArgoCD Sync.
  - Address bootstrap-mongodb Job hanging issues with TLS-required managed MongoDB.
  - Drop dead environment variables, derive NEXTAUTH_URL from ingress, sync NEXT_PUBLIC_PLUGIN_AUTH_ENABLED, and allow client_id via secret.
