...
- **Features**
  - Added support for idempotent MongoDB user/db provisioning with `bootstrap-mongodb.yaml`.
  - Made app user and roles configurable via values in the MongoDB bootstrap process.
