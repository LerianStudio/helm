...
- **Features:**
  ...
  - Updated reporter-manager to version 1.2.0 and reporter-worker to version 1.2.0, including new environment variables.
...
Contributors: @ferr3ira-gabriel, @ferr3ira.gabriel, @gandalf, @guimoreirar, @lucas.bedatty
