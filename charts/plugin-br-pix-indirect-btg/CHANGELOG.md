...
- **Improvements:**
  - Refactored mTLS implementation to use `fsGroup` and 0440 direct mount, eliminating the need for an init container.
  - Dropped hand-written `mTLS.md` documentation as it is now auto-generated on release.
  - Added guidance for kubectl secret creation and emphasized no-plaintext-in-values.
