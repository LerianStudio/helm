...
- Features:
  - Introduced new data fetching algorithm to improve performance and reduce latency.
  - Added support for custom headers in API requests.

- Fixes:
  - Resolved issue with incorrect data parsing in specific edge cases.
  - Fixed bug causing occasional timeout errors during data retrieval.
