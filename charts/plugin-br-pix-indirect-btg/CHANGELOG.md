...
- **Features**
  ...
  - Implemented a per-chart values.schema.json generator for better CI integration.

- **Fixes**
  - Addressed CodeRabbit review comments on the revamp PR.
  - Fixed single-source infra secrets for improved reliability.
  - Corrected value key typo and removed stale README notes.

- **Improvements**
  - Standardized charts to align with the Lerian chart contract, ensuring consistency across deployments.
  - Pinned Bitnami dependency versions to maintain stability.
