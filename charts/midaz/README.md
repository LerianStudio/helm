...
| `ledger.image.tag` | Image tag used for deployment. | `"3.8.0"` |
...
| `crm.image.tag` | Image tag used for deployment. | `"3.8.0"` |
...
- **Version:** pinned exactly to the `lerian-common` chart version the pipeline publishes (currently `1.3.4`)
